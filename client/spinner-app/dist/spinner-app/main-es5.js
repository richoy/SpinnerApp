...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppCustomizeSpinnerCustomizeSpinnerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CustomizeSpinnerComponent = /*#__PURE__*/function () {
      ...
      imageService) {
        ...
        this.imageService = imageService; //Collapse menu
        ...
        this.UnsuccessfullyUpload = []; // Setting Form Array
      ...
      _createClass(CustomizeSpinnerComponent, [{
        ...
        value: function onSuccess(index, path) {
          ...
          this.UnsuccessfullyUpload[index] = false; //this.selectedFile.pending = false;
        ...
        value: function onError(index) {
          ...
          this.SuccessfullyUpload[index] = false; //this.selectedFile.pending = false;
        ...
        value: function processFile(image, index) {
          ...
          reader.addEventListener('load', function (event) {
            _this.selectedFile = new _shared_ImageSnippet__WEBPACK_IMPORTED_MODULE_3__["ImageSnippet"](event.target.result, file);

            _this.imageService.uploadImage(_this.selectedFile.file).subscribe(function (res) {
              _this.onSuccess(index, res.path);
            }, function (err) {
              _this.onError(index);
        ...
        value: function onSubmit() {
          ...
          if (this.spinnerForm.status === "VALID") {
            ...
            this.spinnerArray.value.forEach(function (element) {
              ...
              _this2.StringOfImageUpload.forEach(function (file) {
          ...
          this.spinnerService.deleteSpinner().subscribe(function () {
            _this2.spinnerService.sendSpinner(spinner).subscribe(function (res) {
              _this2.spinnerForm.reset();

              _this2.StringOfImageUpload = []; // Resets the StringOfImageUpload array
            }, function (err) {
  ...
  function srcAppServicesEmailsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    EmailsService.ɵfac = function EmailsService_Factory(t) {
      return new (t || EmailsService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_process_httpmsg_service__WEBPACK_IMPORTED_MODULE_3__["ProcessHTTPMsgService"]));
    };
  ...
  function srcAppSpinnerSpinnerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SpinnerComponent_div_1_div_2_div_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SpinnerComponent_div_1_div_2_div_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 13);
    ...
    function SpinnerComponent_div_1_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SpinnerComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SpinnerComponent_div_1_Template_div_click_3_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r11.rotate();
        });
      ...
      _createClass(SpinnerComponent, [{
        ...
        value: function getSpinner() {
          ...
          this.spinnerService.getSpinner().subscribe(function (spinnerFields) {
            ...
            _this4.SpinnerFields = spinnerFields;
            var angle = 360 / _this4.SpinnerFields.length;

            for (var i = 0; i < _this4.SpinnerFields.length; i++) {
              //Substitute backslashes for slashes
              _this4.SpinnerFields[i].image = _this4.SpinnerFields[i].image.replace(/\\/g, "/");
              _this4.SpinnerFields[i].image = _this4.API_IMAGE_URL + _this4.SpinnerFields[i].image.slice(14);
              _this4.bgColorStyle[i] = _this4.SpinnerFields[i].bgColor; // Backgorund color

              _this4.fontColor[i] = _this4.spinnerService.invertColor(_this4.bgColorStyle[i]); //Font Color
              ...
              _this4.fieldStyleNth[i] = {
                'transform': 'rotate(' + angle + 'deg)',
                '-webkit-transform': 'rotate(' + angle + 'deg)',
                '-moz-transform': 'rotate(' + angle + 'deg)',
                '-o-transform': 'rotate(' + angle + 'deg)',
                '-ms-transform': 'rotate(' + angle + 'deg)',
                'background-color': _this4.bgColorStyle[i],
                'color': _this4.fontColor[i]
              };
              _this4.initialDegreesStart[i] = angle * i;
              _this4.initialDegreesEnd[i] = _this4.initialDegreesStart[i] + angle;
            }
          });
        }
      }, {
        ...
        value: function rotate() {
          ...
          var numberOfSpins = this.totalDegree / 360;
          var fraction = numberOfSpins % 1;
        ...
        key: "tilting",
        value: function tilting() {
          var _this5 = this;

          this.wheelSecs.forEach(function (wheelSec) {
            ...
            var interval = setInterval(function () {
              ...
              _this5.Text.innerHTML = aoY;

              if (aoY.top < 23.89) {
                _this5.spinMovemente = {
        ...
        key: "DeterminResult",
        value: function DeterminResult() {
          for (var i = 0; i < this.initialDegreesEnd.length; i++) {
            //console.log(this.initialDegreesEnd[0]);
            if (this.degreesRotated <= this.initialDegreesEnd[0]) {
              this.resultingField = i;
              break;
            } else if (this.degreesRotated > this.initialDegreesEnd[0] && this.degreesRotated <= this.initialDegreesEnd[i] && this.degreesRotated > this.initialDegreesEnd[i - 1]) {
              this.resultingField = i;
            }
          }

          if (this.SpinnerFields[this.resultingField].isItEmail === true) {///Code to result
          } else if (this.SpinnerFields[this.resultingField].isItEmail === false) {///Code to result
          }
    ...
    SpinnerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 1,
      consts: [["id", "wrapper"], ["id", "wheel", 4, "ngIf"], ["id", "txt"], ["txt", ""], ["id", "wheel"], ["id", "inner-wheel"], [4, "ngFor", "ngForOf"], ["id", "spin", 3, "click"], ["spin", ""], ["id", "inner-spin"], ["id", "shine"], ["wheelSec", ""], ["class", "hold", 3, "style", 4, "ngIf"], [1, "hold"], ["id", "wheelSec", 1, "sec"], ["alt", "", 3, "src"], [1, "sec"]],
