...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingRoutesTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_guards_login_guard__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var routes = [{
      ...
      canActivate: [_services_guards_login_guard__WEBPACK_IMPORTED_MODULE_7__["LoginGuard"]],
      children: [{
  ...
  function srcAppCustomScriptCustomScriptComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CustomScriptComponent_div_34_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CustomScriptComponent_div_34_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CustomScriptComponent_div_34_Template(rf, ctx) {
      if (rf & 1) {
  ...
  function srcAppCustomizeSpinnerCustomizeSpinnerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_form_spinner_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../shared/form-spinner-controller */
    "./src/app/shared/form-spinner-controller.ts");
    /* harmony import */


    var _shared_ImageSnippet__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../shared/ImageSnippet */
    "./src/app/shared/ImageSnippet.ts");
    /* harmony import */


    var _services_spinner_customizer_controller_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    function CustomizeSpinnerComponent_tr_58_td_7_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CustomizeSpinnerComponent_tr_58_td_7_Template_input_change_6_listener($event) {
          ...
          return ctx_r19.processFile($event, i_r8);
        });
    ...
    function CustomizeSpinnerComponent_tr_58_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CustomizeSpinnerComponent_tr_58_Template_select_change_2_listener($event) {
          ...
          return ctx_r22.onChangeImage($event.target.value, i_r8);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function CustomizeSpinnerComponent_tr_58_Template_input_keyup_11_listener() {
          ...
          return ctx_r24.MessageErrorChange(i_r8);
          ...
          return ctx_r25.MessageErrorChange(i_r8);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CustomizeSpinnerComponent_tr_58_Template_select_change_16_listener($event) {
          ...
          return ctx_r26.onChangeResult($event.target.value, i_r8);
        });
      ...
      if (rf & 2) {
        var spinnerfield_r7 = ctx.$implicit;
        var i_r8 = ctx.index;
    ...
    function CustomizeSpinnerComponent_div_82_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 58);
    ...
    function CustomizeSpinnerComponent_div_83_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 59);
      ...
      _createClass(CustomizeSpinnerComponent, [{
        ...
        value: function createSpFormGroup() {
          ...
          SpinnerForm.valueChanges.subscribe(function (data) {
            _this4.onValueChanged(SpinnerForm, data);
          });
        ...
        value: function MessageErrorChange(i) {
          ...
          allEvents$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (event) {
            ...
            if (value > 100) {
              _this5.isPercentageMoreThanHundred[i] = true;
              _this5.percentageValues[i] = value;
            } else if (value < 0) {
              _this5.isPercentageLessThanZero[i] = true;
              _this5.percentageValues[i] = value;
            } else if (value >= 0 && value <= 100) {
              _this5.isPercentageMoreThanHundred[i] = false;
              _this5.isPercentageLessThanZero[i] = false;
              _this5.percentageValues[i] = value;
            }

            _this5.checkfullpercentage();
        ...
        value: function processFile(image, index) {
          ...
          var reader = new FileReader();
          reader.addEventListener('load', function (event) {
            _this6.selectedFile = new _shared_ImageSnippet__WEBPACK_IMPORTED_MODULE_5__["ImageSnippet"](event.target.result, file);

            _this6.imageService.uploadImage(_this6.selectedFile.file).subscribe(function (res) {
              _this6.onSuccess(index, res.path);
            }, function (err) {
              _this6.onError(index);
        ...
        value: function ProcessCenterImage(image) {
          ...
          var reader = new FileReader();
          reader.addEventListener('load', function (event) {
            _this7.selectedCenterFile = new _shared_ImageSnippet__WEBPACK_IMPORTED_MODULE_5__["ImageSnippet"](event.target.result, file);

            _this7.imageService.uploadImage(_this7.selectedCenterFile.file).subscribe(function (res) {
              _this7.onSuccessCenter(res.path);
            }, function (err) {
              _this7.onErrorCenter();
        ...
        value: function onSubmit() {
          ...
          if (this.spinnerForm.status === "VALID") {
            ...
            this.spinnerArray.value.forEach(function (element) {
              var field = new _shared_form_spinner_controller__WEBPACK_IMPORTED_MODULE_4__["formSpinnerControl"](element.isItImage, element.image, element.textFieldOne, element.percentage, element.isItEmail, element.textPopUp, element.email, element.color);
              _this8.totalPercentage[counter] = element.percentage;

              _this8.StringOfImageUpload.forEach(function (file) {
          ...
          if (this.percentageSum === 100) {
            this.spinnerService.deleteSpinner().subscribe(function () {
              _this8.spinnerService.sendSpinner(spinner).subscribe(function (res) {
                _this8.spinnerForm.reset();

                _this8.StringOfImageUpload = []; // Resets the StringOfImageUpload array
              }, function (err) {
                throw new Error('Error Sending the information about the spinner');
              });
            }, function (err) {
        ...
        value: function onSubmitCenterImage() {
          ...
          this.centerImageService.deleteImageCenter().subscribe(function () {
            _this9.centerCopy = _this9.CenterImageForm.value;
            _this9.centerCopy.centerImage = _this9.StringOfSpinnerCenter.replace(/\\/g, "/");

            _this9.centerImageService.sendImageCenter(_this9.centerCopy).subscribe(function (HFform) {
              _this9.centerform = HFform;
              console.log(_this9.centerform);
            }, function (err) {
              throw new Error('Error Sending the information about the spinner');
            });

            _this9.CenterImageForm.reset();
          }, function (err) {
            throw new Error('Error deleting the information of the previous spineer');
          });
        }
    ...
    CustomizeSpinnerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CustomizeSpinnerComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function CustomizeSpinnerComponent_Template_form_ngSubmit_72_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CustomizeSpinnerComponent_Template_button_click_76_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CustomizeSpinnerComponent_Template_input_change_79_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CustomizeSpinnerComponent_Template_button_click_88_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CustomizeSpinnerComponent, [{
        ...
        return [{
          ...
          type: _services_spinner_customizer_controller_service__WEBPACK_IMPORTED_MODULE_6__["SpinnerCustomizerControllerService"]
        }, {
  ...
  function srcAppEmailListEmailListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_csvconverter_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var EmailListComponent = /*#__PURE__*/function () {
      function EmailListComponent(emailService, csvService) {
    ...
    EmailListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 1,
      consts: [[1, "bgColor"], [1, "container", "col-12", "col-lg-10"], ["id", "title"], [1, "row"], [1, "col-12", "d-flex", "justify-content-end", "mb-5"], [1, "btn", "btn-info", 3, "click"], ["class", "table-responsive", 4, "ngIf"], [1, "table-responsive"], [1, "table", "table-striped"], [4, "ngFor", "ngForOf"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EmailListComponent, [{
        ...
        return [{
          ...
          type: _services_csvconverter_service__WEBPACK_IMPORTED_MODULE_2__["CSVconverterService"]
        }];
      }, null);
    })();
          ...
          if (this.LoginForm.status === "VALID") {
            ...
            this.loginservice.Login(user).subscribe(function (resp) {
              if (resp.success === true) {
                _this11.LoginError = false;
                localStorage.setItem("userToken", resp.token);

                _this11.router.navigate(['backend-control/customize-spinner']);
              }
            }, function (err) {
              _this11.LoginError = true;
            });
          }
        }
      }]);
        ...
        value: function onSubmit() {
          ...
          if (this.PasswordChangeForm.status === "VALID") {
            ...
            this.changePasswordservice.ChangePassword(user).subscribe(function (resp) {
              if (resp.success === true) {
                _this13.PasswordChangeError = false;

                _this13.open(_this13.modal);
              }
            }, function (err) {
              _this13.PasswordChangeError = true;
            });
          }
        }
      }]);
  ...
  function srcAppServicesChangePasswordServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ChangePasswordService.ɵfac = function ChangePasswordService_Factory(t) {
      return new (t || ChangePasswordService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]));
    };
  ...
  function srcAppSpinnerSpinnerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_header_footer_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../services/header-footer.service */
    "./src/app/services/header-footer.service.ts");
    /* harmony import */


    var _services_emails_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../services/emails.service */
    "./src/app/services/emails.service.ts");
    /* harmony import */
    ...
    function SpinnerComponent_ng_template_8_div_4_div_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SpinnerComponent_ng_template_8_div_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function SpinnerComponent_ng_template_8_div_4_Template_form_ngSubmit_3_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SpinnerComponent_ng_template_8_div_4_Template_button_click_14_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r25);
      ...
      _createClass(SpinnerComponent, [{
        ...
        value: function getSpinner() {
          ...
          this.spinnerService.getSpinner().subscribe(function (spinnerFields) {
            _this14.SpinnerFields = spinnerFields;
            _this14.angle = 360 / _this14.SpinnerFields.length;

            for (var i = 0; i < _this14.SpinnerFields.length; i++) {
              //Substitute backslashes for slashes
              _this14.SpinnerFields[i].image = _this14.SpinnerFields[i].image.replace(/\\/g, "/");
              _this14.SpinnerFields[i].image = _this14.API_IMAGE_URL + _this14.SpinnerFields[i].image.slice(14);
              _this14.bgColorStyle[i] = _this14.SpinnerFields[i].bgColor; // Backgorund color

              _this14.fontColor[i] = _this14.spinnerService.invertColor(_this14.bgColorStyle[i]); //Font Color

              _this14.holder[i] = {
                'transform': 'rotate(' + _this14.angle * i + 'deg)',
                '-webkit-transform': 'rotate(' + _this14.angle * i + 'deg)',
                '-moz-transform': 'rotate(' + _this14.angle * i + 'deg)',
                '-o-transform': 'rotate(' + _this14.angle * i + 'deg)',
                '-ms-transform': 'rotate(' + _this14.angle * i + 'deg)'
              };
              _this14.fieldStyleNth[i] = {
                'transform': 'rotate(' + _this14.angle + 'deg)',
                '-webkit-transform': 'rotate(' + _this14.angle + 'deg)',
                '-moz-transform': 'rotate(' + _this14.angle + 'deg)',
                '-o-transform': 'rotate(' + _this14.angle + 'deg)',
                '-ms-transform': 'rotate(' + _this14.angle + 'deg)',
                'background-color': _this14.bgColorStyle[i],
                'color': _this14.fontColor[i]
              };
              _this14.initialDegreesStart[i] = _this14.angle * i;
              _this14.initialDegreesEnd[i] = _this14.initialDegreesStart[i] + _this14.angle;
            }
          });
        }
      }, {
        ...
        value: function getHeaderFooter() {
          ...
          this.headerFooterService.getHeaderFooter().subscribe(function (headerFooter) {
            _this15.HeaderFooter = headerFooter[0];
          });
        }
      }, {
        key: "getImageCenter",
        value: function getImageCenter() {
          ...
          this.centerImageService.getImageCenter().subscribe(function (centerImage) {
            _this16.centerImage = centerImage[0];
            _this16.centerImage.centerImage = _this16.API_IMAGE_URL + _this16.centerImage.centerImage.slice(14); //console.log(centerImage);
          });
        }
      }, {
        key: "rotate",
        ...
        value: function ExposingResult() {
          ...
          if (this.SpinnerFields[this.resultingField].isItEmail === true) {
            setTimeout(function () {
              _this17.open(_this17.ResultEmail);
            }, 6500);
          } else if (this.SpinnerFields[this.resultingField].isItEmail === false) {
            setTimeout(function () {
              _this17.open(_this17.ResultText);
            }, 6500);
          }
        }
      }, {
        ...
        value: function onSubmit() {
          ...
          if (this.sendEmailForm.status === "VALID") {
            ...
            this.emailSevice.sendEmails(this.formCopy).subscribe(function (emailForm) {
              _this18.form = emailForm;

              _this18.modalService.dismissAll();

              _this18.validForm = true;
            }, function (err) {
              throw new Error('Error Sending the information about the spinner');
            });
        ...
        value: function CalculateDegreesRotated() {
          ...
          this.resultingField = index; //console.log(index);

          this.FinalResult = this.SpinnerFields[index]; //console.log(this.FinalResult)
        } // Modal results
    ...
    SpinnerComponent.ɵfac = function SpinnerComponent_Factory(t) {
      return new (t || SpinnerComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_spinner_service__WEBPACK_IMPORTED_MODULE_3__["SpinnerService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_header_footer_service__WEBPACK_IMPORTED_MODULE_4__["HeaderFooterService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_emails_service__WEBPACK_IMPORTED_MODULE_5__["EmailsService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_center_image_service__WEBPACK_IMPORTED_MODULE_6__["CenterImageService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SpinnerComponent, [{
        ...
        return [{
          ...
          type: _services_header_footer_service__WEBPACK_IMPORTED_MODULE_4__["HeaderFooterService"]
        }, {
          type: _services_emails_service__WEBPACK_IMPORTED_MODULE_5__["EmailsService"]
        }, {
          type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"]
        }, {
