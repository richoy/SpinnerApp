        ...
        value: function getSpinner() {
          ...
          this.spinnerService.getSpinner().subscribe(function (spinnerFields) {
            ...
            for (var i = 0; i < _this15.SpinnerFields.length; i++) {
              ...
              _this15.imageOrientation[i] = {
                'transform': 'rotate(' + (_this15.angle - _this15.angle * 1.5) + 'deg)',
                '-webkit-transform': 'rotate(' + (_this15.angle - _this15.angle * 1.5) + 'deg)',
                '-moz-transform': 'rotate(' + (_this15.angle - _this15.angle * 1.5) + 'deg)',
                '-o-transform': 'rotate(' + (_this15.angle - _this15.angle * 1.5) + 'deg)',
                '-ms-transform': 'rotate(' + (_this15.angle - _this15.angle * 1.5) + 'deg)',
                'transform-origin': 'bottom center'
              };
              _this15.textOrientation[i] = {
                'transform': 'rotate(' + (90 - _this15.angle / 2) + 'deg)',
                '-webkit-transform': 'rotate(' + (180 + _this15.angle / 4) + 'deg)',
                '-moz-transform': 'rotate(' + (180 + _this15.angle / 4) + 'deg)',
                '-o-transform': 'rotate(' + (180 + _this15.angle / 4) + 'deg)',
                '-ms-transform': 'rotate(' + (180 + _this15.angle / 4) + 'deg)',
